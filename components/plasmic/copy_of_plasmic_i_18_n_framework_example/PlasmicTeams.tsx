...
import sty from "./PlasmicTeams.module.css"; // plasmic-import: ayK4QLc_yCsZ/css
    ...
    >
      ...
      >
        <PlasmicImg__
          ...
          loading={"lazy"}
          src={{
            src: "/plasmic/copy_of_plasmic_i_18_n_framework_example/images/teampng.png",
            fullWidth: 128,
            fullHeight: 128,
        ...
        >
          <Trans__>{"Founder Flappin"}</Trans__>
        </div>
        <div
          className={classNames(
            projectcss.all,
