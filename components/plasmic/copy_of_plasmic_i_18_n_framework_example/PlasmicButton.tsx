...
import sty from "./PlasmicButton.module.css"; // plasmic-import: MU3DMwx9AwSp/css
    ...
    >
      {(
        ...
        ? renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__dwDel)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? renderPlasmicSlot({
            defaultContents: (
              <ChevronRightIcon
                className={classNames(projectcss.all, sty.svg__k9V2V)}
                role={"img"}
              />
            ),
