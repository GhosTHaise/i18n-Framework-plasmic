...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: l0ECaHCt1rWZ/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <Searchsvg2Icon
              className={classNames(projectcss.all, sty.svg___4EEp8)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg__xPx2U)}
              role={"img"}
            />
          ),
